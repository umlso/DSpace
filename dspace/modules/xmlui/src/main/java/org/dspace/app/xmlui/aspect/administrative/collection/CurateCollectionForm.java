...
import com.atmire.dspace.app.xmlui.aspect.administrative.plugins.EditFormAdditionsManager;
...
public class CurateCollectionForm extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body)
        ...
        for (String key : EditFormAdditionsManager.getInstance().getOptionKeys(Constants.COLLECTION)) {
            options.addItem().addXref(baseURL + "&submit_addition&addition_key=" + key, message("xmlui.administrative.collection.general.options_" + key));
        }
