...
public class CurateCommunityForm extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body)
        ...
        for (String key : EditFormAdditionsManager.getInstance().getOptionKeys(Constants.COMMUNITY)) {
            options.addItem().addXref(baseURL + "&submit_addition&addition_key=" + key, message("xmlui.administrative.community.general.options_" + key));
        }
